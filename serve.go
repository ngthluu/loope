...
func NewServer(r Runner, cfg *Config) (*Server, error) {
	...
	return &Server{runner: r, cfg: cfg, gh: NewGitHub(r, cfg), page: page, rail: rail, detail: detail,
		ttl: defaultGHTTL, now: time.Now, prTried: map[int]bool{}, titleTried: map[int]bool{}}, nil
}
