...
func (u *UAT) RunFeature(ctx context.Context, c shared.Agent, cfg *shared.Config, wtPath, specPath string) {
...
// guard.
func (u *UAT) StartFeature(ctx context.Context, c shared.Agent, cfg *shared.Config, wtPath, specPath string) (wait func()) {
	if u == nil || u.Target == nil {
		return func() {}
	}
...
func (u *UAT) RunBug(ctx context.Context, c shared.Agent, cfg *shared.Config, wtPath, issueContent, base string) {
	if u == nil || u.Target == nil {
		return
	}
...
func (u *UAT) run(ctx context.Context, c shared.Agent, cfg *shared.Config, wtPath, label, prompt string) {
	if u == nil || u.Target == nil {
		return
	}
