...
func RunMergeResolve(ctx context.Context, c *Claude, cfg *Config, wt *Worktree, wtPath, base string) (summary string, err error) {
	...
	res, cerr := c.Call(ctx, ClaudeCall{
...
func (o *Orchestrator) handleMergeResolve(ctx context.Context, issue Issue, base string) error {
	n := issue.Number
...
func (o *Orchestrator) parkMergeResolve(ctx context.Context, n int, cause error) error {
	...
	_ = o.gh.Comment(cctx, n, mergeResolveParkComment(o.cfg.StateLabels.Rework, o.cfg.MergeResolveLabel, classifyCause(cause.Error()), clip(cause.Error(), 6000)))
	_ = o.gh.SwapLabels(cctx, n, o.cfg.StateLabels.WIP, o.cfg.StateLabels.Rework)
	recordState(logDir, o.cfg.StateLabels.Rework)
	recordParkCause(logDir, cause.Error())
	clearMergeResolvePrior(logDir)
	return cause
}
...
func currentStateLabel(labels []Label, sl StateLabels) string {
