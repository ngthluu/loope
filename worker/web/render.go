...
func templateFuncs(cfg *shared.Config) template.FuncMap {
...
// renames its labels.
func stateKind(cfg *shared.Config, label string) string {
	switch label {
...
func stripeClass(cfg *shared.Config, label string) string {
